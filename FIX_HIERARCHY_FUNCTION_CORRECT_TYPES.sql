-- FIX HIERARCHY FUNCTION WITH CORRECT TYPES
-- This script checks the actual column types and fixes the functions accordingly
...
-- 3. Recreate the function with correct types based on actual table structure
...
-- 4. Recreate the org structure function with correct types
...
RETURNS TABLE (
    ...
    parent_leader_name VARCHAR(100),
    level INTEGER,
    is_leader BOOLEAN,
