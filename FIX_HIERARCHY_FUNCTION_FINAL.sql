-- FIX HIERARCHY FUNCTION FINAL VERSION
...
-- 3. Create a simple function that returns the correct types
...
-- 4. Create the org structure function with correct types
...
BEGIN
    ...
    WITH user_hierarchy AS (
        ...
        SELECT 
            ...
            s.role::TEXT,
            s.parent_leader_id,
            u.name::TEXT as parent_leader_name,
            uh.level + 1 as level,
