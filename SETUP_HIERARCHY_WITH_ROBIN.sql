-- SETUP HIERARCHY WITH ROBIN UNDER DANIEL
-- This script sets up the correct hierarchy structure with Robin under Daniel
...
-- Daniel (Admin) -> Robin Ache (Führungskraft) -> (future subordinates)

-- First, clear any existing parent_leader_id relationships
UPDATE users SET parent_leader_id = NULL;
...
-- Set Robin as subordinate of Daniel
UPDATE users 
SET parent_leader_id = '502e90ae-3557-48d1-8028-408fe9ee2c49' 
WHERE id = 'd5ab3e67-7f68-41f9-8af1-dfbc429f640b';
...
-- Test Daniel's subordinates (should show Philipp, Kosta, and Robin)
...
-- Test Robin's subordinates (should be empty for now)
SELECT 'Robin''s subordinates:' as test;
SELECT * FROM get_user_subordinates('d5ab3e67-7f68-41f9-8af1-dfbc429f640b');
