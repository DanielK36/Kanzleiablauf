-- FIX HIERARCHY FUNCTION FINAL WORKING VERSION
-- This script creates working hierarchy functions with correct types
...
-- 4. Create a simpler org structure function with correct types
